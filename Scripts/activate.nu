...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\damka\Selenium WebDriver with Python'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\damka\Selenium WebDriver with Python\Scripts\deactivate.nu'
